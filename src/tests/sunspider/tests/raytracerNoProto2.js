...
// triangleIntersect either returns a value or null. Here I refactor it, but in raytracerNoProto.js it is labelled dynamic
...
function Triangle(p1, p2, p3) {
    ...
    // all triangles have a shader (cl554 edit)
    triangle.shader = function(tri, pos, view) {
        var colour = this.material;
        colour.reflection = 0;
        return colour;
    };
